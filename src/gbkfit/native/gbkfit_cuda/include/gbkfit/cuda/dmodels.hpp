...
private:
    ...
    mutable T* m_wcube_c;
    mutable T* m_psf3d_c;
    mutable cufftHandle m_scube_plan_r2c;
    mutable cufftHandle m_scube_plan_c2r;
    mutable cufftHandle m_wcube_plan_r2c;
    mutable cufftHandle m_wcube_plan_c2r;
    mutable cufftHandle m_psf3d_plan_r2c;
};
