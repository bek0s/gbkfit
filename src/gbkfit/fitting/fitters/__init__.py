...
def _register_fitters():
    ...
    parsers = [
        ...
        # optuna
        'gbkfit.fitting.fitters.optuna.FitterOptunaGrid',
        'gbkfit.fitting.fitters.optuna.FitterOptunaRandom',
        'gbkfit.fitting.fitters.optuna.FitterOptunaTpe',
        'gbkfit.fitting.fitters.optuna.FitterOptunaCmaes',
        'gbkfit.fitting.fitters.optuna.FitterOptunaGp',
        'gbkfit.fitting.fitters.optuna.FitterOptunaNsga2',
        'gbkfit.fitting.fitters.optuna.FitterOptunaNsga3',
        'gbkfit.fitting.fitters.optuna.FitterOptunaQmc',
        'gbkfit.fitting.fitters.optuna.FitterOptunaBruteForce',
        # # pymoo
